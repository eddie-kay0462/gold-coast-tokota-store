<template>
  ...
  <section class="page-gutter mx-auto flex w-full max-w-[1440px] flex-col items-start gap-2 py-12 lg:py-16">
    <div class="h-[14px] w-full bg-graphite" />

    <div class="flex w-full flex-col items-start text-black">
      <h1 class="w-full font-normal text-display-brand">
        Gold Coast Tokota
      </h1>
      <p class="w-full font-light text-lede">
