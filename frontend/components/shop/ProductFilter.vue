...
<template>
  <aside class="flex w-full shrink-0 flex-col gap-px lg:w-[196px]" aria-label="Product filters">
    ...
    <div v-show="open.type" id="filter-type" class="flex w-full flex-col gap-1.5">
      ...
      <button
        ...
        type="button"
        class="flex w-full items-start pb-5 pt-1 text-left text-caption text-subtle"
      ...
      >
        ...
        <div class="grid grid-cols-4 gap-1">
          <button
            ...
            :key="size"
            type="button"
            class="flex min-w-0 items-center justify-center p-3 text-caption"
